package com.infernal93.videocallingdemo.activities
...
import com.infernal93.videocallingdemo.R
import com.infernal93.videocallingdemo.fragments.PreviewCallFragment
import com.infernal93.videocallingdemo.utils.*
import com.quickblox.chat.QBChatService
import com.quickblox.chat.QBWebRTCSignaling
import com.infernal93.videocallingdemo.fragments.VideoConversationFragment
...
class CallActivity : AppCompatActivity(), QBRTCClientSessionCallbacks,
    PreviewCallFragment.CallFragmentCallbackListener,
    ...
    private fun initPreviewFragment() {
        ...
        addFragment(supportFragmentManager,
            R.id.fragment_container, previewFragment, PreviewCallFragment::class.java.simpleName)
    }
    ...
    private fun initConversationFragment(incoming: Boolean) {
        ...
        addFragmentWithBackStack(supportFragmentManager,
            R.id.fragment_container, conversationFragment, VideoConversationFragment::class.java.simpleName)
    }
